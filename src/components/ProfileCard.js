  ...
  return (
    ...
    >
      <Box  sx={{ paddingTop: "1rem",paddingBottom: "1rem"}}>
        <CardMedia
          sx={{ width: 200, borderRadius: "100%",position: "relative",boxShadow: "0px 5px 50px 0px #6c44fc, 0px 0px 0px 7px rgb(107 74 255 / 50%)" }}
          component="img"
          alt="green iguana"
          height="200"
      ...
      <CardActions sx={{ color: "#6944ff", paddingTop: "2rem",paddingBottom: "2rem"}}>
        <Button size="small" href="https://www.linkedin.com/in/yoseph-alemu-759391113/">
          <LinkedIn 
          sx={{
            fontSize: 40,
            color: "#405de6",
            boxShadow:"0px 5px 50px 0px #6c44fc, 0px 0px 0px 7px rgb(107 74 255 / 50%)",
            borderRadius: "100%"
          }}/>
        </Button>
